...
const REDUCER_PARAM_STRUCTS: Partial<Record<string, keyof OptionFieldMap & string>> = {
  add_account_move_line: "AddAccountMoveLineParams",
  ...
  create_contact_identity: "CreateContactIdentityParams",
  assign_contact_role: "AssignContactRoleParams",
  ...
  create_pricelist: "CreatePricelistParams",
  ...
  create_payment_account: "CreatePaymentAccountParams",
  create_payment_transaction: "CreatePaymentTransactionParams",
  create_payment_fee: "CreatePaymentFeeParams",
  allocate_payment_transaction: "AllocatePaymentParams",
  reverse_payment_transaction: "ReversePaymentTransactionParams",
