...
> = {
  ...
  create_consignment_agreement: ["consignment-agreements"],
  create_landed_cost: ["landed-costs", "purchase-orders"],
  create_partner_bank: ["partner-banks"],
  create_purchase_blanket_order: ["purchase-blanket-orders", "purchase-blanket-order-lines"],
  create_purchase_contract: ["purchase-contracts"],
  ...
  create_purchasing_integration_intent: ["purchasing-integration-intents"],
  create_vendor_credit_from_purchase_return: [
    "purchase-returns",
    "account-moves",
  ],
  ...
  record_purchasing_integration_result: ["purchasing-integration-intents"],
  reject_supplier_intake: ["supplier-intakes", "contacts"],
  release_blanket_to_po: ["purchase-blanket-orders", "purchase-blanket-order-lines", "purchase-blanket-releases", "purchase-orders", "purchase-order-lines", "purchase-orders-to-approve"],
  ...
  set_commodity_price_index: ["commodity-price-indexes"],
  set_purchase_approval_delegate: ["purchase-approval-delegates"],
  set_vendor_risk_flag: ["vendor-risk-flags"],
  ...
  upsert_vendor_scorecard: ["vendor-scorecards"],
};
