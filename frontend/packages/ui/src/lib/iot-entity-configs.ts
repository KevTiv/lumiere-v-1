...
export const iotAlertsTableConfig = (_t: TFunction): EntityViewConfig => ({
  id: "iot-alerts-table",
  title: "IoT Alerts",
  description: "Device alerts generated by thresholds and hub events.",
  view: {
    mode: "table",
    rowKey: "id",
    searchable: true,
    searchPlaceholder: "Search alerts",
    searchKeys: ["alert_type", "severity", "message"],
    columns: [
      { key: "id", label: "ID", type: "number", align: "right", width: "min-w-16" },
      { key: "device_id", label: "Device", type: "number", align: "right" },
      { key: "alert_type", label: "Type", width: "min-w-28" },
    ...
    emptyMessage: "No IoT alerts",
  },
})

export const iotThresholdsTableConfig = (_t: TFunction): EntityViewConfig => ({
  id: "iot-thresholds-table",
  title: "IoT Thresholds",
  description: "Sensor threshold rules used to create alerts.",
  view: {
    mode: "table",
    rowKey: "id",
    searchable: true,
    searchPlaceholder: "Search thresholds",
    searchKeys: ["sensor_type", "severity"],
    columns: [
      { key: "id", label: "ID", type: "number", align: "right", width: "min-w-16" },
      { key: "device_id", label: "Device", type: "number", align: "right" },
      { key: "sensor_type", label: "Sensor", width: "min-w-28" },
      { key: "min_value", label: "Min", type: "number", align: "right" },
      { key: "max_value", label: "Max", type: "number", align: "right" },
      { key: "severity", label: "Severity", type: "badge" },
      { key: "updated_at", label: "Updated", type: "datetime" },
    ],
    emptyMessage: "No IoT thresholds",
  },
})
