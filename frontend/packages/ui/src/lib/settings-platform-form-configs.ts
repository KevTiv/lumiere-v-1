...
export function addCasbinRuleForm(t: TFunction): FormConfig {
  return {
    id: "settings-add-casbin-rule",
    title: t("settings.adminOps.casbin.addTitle"),
    description: t("settings.adminOps.casbin.addDescription"),
    submitLabel: t("settings.adminOps.casbin.addSubmit"),
    sections: [
      {
        id: "policy",
        fields: [
          {
            ...
            name: "ptype",
            type: "select",
            label: t("settings.adminOps.casbin.ptype"),
            required: true,
            defaultValue: "p",
            width: "1/3",
            options: [
              { value: "p", label: t("settings.adminOps.casbin.ptypePolicy") },
              { value: "g", label: t("settings.adminOps.casbin.ptypeGrouping") },
            ],
          },
          { id: "v0", name: "v0", type: "text", label: "v0", width: "1/3" },
          { id: "v1", name: "v1", type: "text", label: "v1 (org id)", width: "1/3" },
          { id: "v2", name: "v2", type: "text", label: "v2", width: "1/3" },
          { id: "v3", name: "v3", type: "text", label: "v3", width: "1/3" },
          { id: "v4", name: "v4", type: "text", label: "v4", width: "1/3" },
          { id: "v5", name: "v5", type: "text", label: "v5", width: "1/3" },
          {
            id: "metadata",
            name: "metadata",
            type: "textarea",
            label: t("settings.adminOps.casbin.metadata"),
            rows: 3,
            width: "full",
          },
        ],
...
export function removeCasbinRuleForm(t: TFunction): FormConfig {
  return {
    ...
    submitLabel: t("settings.adminOps.casbin.removeSubmit"),
    sections: [
      {
        id: "rule",
        fields: [
