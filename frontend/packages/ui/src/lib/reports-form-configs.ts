...
export const newTrialBalanceEntryForm = (t: TFunction): FormConfig => ({
  id: "new-trial-balance-entry",
  title: t("reports.forms.trialBalanceEntry.title"),
  description: t("reports.forms.trialBalanceEntry.description"),
  sections: [
    {
      id: "entry-main",
      title: t("reports.forms.trialBalanceEntry.sections.main"),
      fields: [
        {
          id: "reportId",
          name: "reportId",
        ...
        },
        {
          ...
          name: "accountCode",
          type: "text",
          label: t("reports.forms.trialBalanceEntry.fields.accountCode"),
          required: true,
          width: "1/3",
        },
        {
          ...
          name: "accountName",
          type: "text",
          label: t("reports.forms.trialBalanceEntry.fields.accountName"),
          required: true,
          width: "2/3",
        },
        {
          ...
          name: "openingDebit",
          type: "text",
          label: t("reports.forms.trialBalanceEntry.fields.openingDebit"),
          width: "1/3",
          defaultValue: "0",
        },
        {
          ...
          name: "openingCredit",
          type: "text",
          label: t("reports.forms.trialBalanceEntry.fields.openingCredit"),
          width: "1/3",
          defaultValue: "0",
        },
        {
          ...
          name: "periodDebit",
          type: "text",
          label: t("reports.forms.trialBalanceEntry.fields.periodDebit"),
          width: "1/3",
          defaultValue: "0",
        },
        {
          ...
          name: "periodCredit",
          type: "text",
          label: t("reports.forms.trialBalanceEntry.fields.periodCredit"),
          width: "1/3",
          defaultValue: "0",
        },
        {
          ...
          name: "closingDebit",
          type: "text",
          label: t("reports.forms.trialBalanceEntry.fields.closingDebit"),
          width: "1/3",
          defaultValue: "0",
        },
        {
          ...
          name: "closingCredit",
          type: "text",
          label: t("reports.forms.trialBalanceEntry.fields.closingCredit"),
          width: "1/3",
          defaultValue: "0",
        },
        {
        ...
        },
        {
          ...
          name: "level",
          type: "text",
          label: t("reports.forms.trialBalanceEntry.fields.level"),
          width: "1/3",
          defaultValue: "1",
        },
        {
          ...
          name: "isLeaf",
          type: "checkbox",
          label: t("reports.forms.trialBalanceEntry.fields.isLeaf"),
          width: "1/3",
          defaultValue: true,
        },
      ],
