...
export function NotebookCellComponent({
  ...
  return (
    ...
    >
      ...
      {/* Cell content */}
      <div className={cell.type === "code" ? "" : "p-3"}>
        {cell.type === "code" ? (
          <CodeMirrorEditor
            value={cell.content}
          ...
          <textarea
            ...
            className="w-full bg-transparent border-none outline-none resize-none font-sans text-xs placeholder:text-muted-foreground/50"
            placeholder="Enter markdown..."
            rows={Math.max(3, cell.content.split("\n").length)}
          />
        ) : (
          <div
            className="text-xs cursor-text min-h-[60px] font-sans prose prose-sm dark:prose-invert max-w-none"
