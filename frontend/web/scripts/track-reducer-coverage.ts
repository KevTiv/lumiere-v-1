...
function categorizeByModule(reducerName: string): string {
  ...
  const prefixMap: Record<string, string> = {
    ...
    create_expense_card_statement_line: 'expenses',
    match_expense_card_statement_line: 'expenses',
    unmatch_expense_card_statement_line: 'expenses',
    ...
    complete_document_signature_request: 'documents',
    sync_external_file_to_document: 'documents',
    set_google_drive_conflict_policy: 'documents',
    update_document_presence: 'documents',
    clear_document_presence: 'documents',
    update_knowledge_article_presence: 'documents',
    clear_knowledge_article_presence: 'documents',
    ...
    set_article_published: 'documents',
    add_article_member: 'documents',
    remove_article_member: 'documents',
    lock_knowledge_article: 'documents',
    unlock_knowledge_article: 'documents',
    create_document_folder: 'documents',
    update_document_folder: 'documents',
    delete_document_folder: 'documents',
    create_document_template: 'documents',
    create_mail_template: 'documents',
    ...
    create_subscription_from_sale_order: 'subscriptions',
    activate_subscription: 'subscriptions',
    close_subscription: 'subscriptions',
    generate_subscription_invoice: 'subscriptions',
    pay_subscription_invoice: 'subscriptions',
    amend_subscription: 'subscriptions',
    advance_subscription_dunning: 'subscriptions',
    record_subscription_payment_failure: 'subscriptions',
    refresh_subscription_exception_flags: 'subscriptions',
    grant_subscription_entitlement: 'subscriptions',
    revoke_subscription_entitlement: 'subscriptions',
    create_subscription_payment_intent: 'subscriptions',
    apply_subscription_payment_intent: 'subscriptions',
    fail_subscription_payment_intent: 'subscriptions',
    create_subscription_tax_settle_intent: 'subscriptions',
    apply_subscription_tax_settle_intent: 'subscriptions',
    upsert_subscription_price_index: 'subscriptions',
    apply_index_linked_renewal: 'subscriptions',
    rebase_deferred_schedules_for_subscription: 'subscriptions',
    ingest_subscription_usage_event: 'subscriptions',
    rate_subscription_usage_events: 'subscriptions',
    create_subscription_price_tier: 'subscriptions',
    set_subscription_commitment: 'subscriptions',
    create_subscription_bundle: 'subscriptions',
    add_subscription_bundle_item: 'subscriptions',
    apply_subscription_bundle: 'subscriptions',
    pause_subscription: 'subscriptions',
    resume_subscription: 'subscriptions',
    renew_subscription: 'subscriptions',
    cancel_subscription: 'subscriptions',
    update_subscription_plan: 'subscriptions',
    deactivate_subscription_plan: 'subscriptions',
    activate_subscription_plan: 'subscriptions',
    create_subscription_plan: 'subscriptions',
    create_deferred_revenue_schedule: 'subscriptions',
    recognize_deferred_revenue: 'subscriptions',
    create_revenue_recognition_rule: 'subscriptions',
    activate_revenue_recognition_rule: 'subscriptions',
    deactivate_revenue_recognition_rule: 'subscriptions',
    import_subscription_csv: 'subscriptions',
    import_subscription_plan_csv: 'subscriptions',

    create_proposal: 'proposals',
    update_proposal: 'proposals',
    upsert_proposal_section: 'proposals',
    resolve_proposal_section_conflict: 'proposals',
    add_proposal_: 'proposals',
    delete_proposal_: 'proposals',
    update_proposal_: 'proposals',
    save_proposal_version: 'proposals',
    restore_proposal_version: 'proposals',
    reorder_proposal_line_items: 'proposals',
    clear_proposal_presence: 'proposals',
    cleanup_stale_proposal_presence: 'proposals',
    resolve_proposal_comment: 'proposals',
    approve_proposal: 'proposals',
    record_proposal_bid_decision: 'proposals',
    ...
    create_proposal_template: 'proposals',
    apply_proposal_template: 'proposals',
    create_proposal_clause: 'proposals',
    upsert_proposal_compliance_requirement: 'proposals',
    apply_proposal_analysis: 'proposals',
    upsert_proposal_procurement_score: 'proposals',
    create_proposal_integration_intent: 'proposals',
    complete_proposal_integration_intent: 'proposals',
    fail_proposal_integration_intent: 'proposals',
    create_proposal_clarification: 'proposals',
    answer_proposal_clarification: 'proposals',
    link_proposal_version_esign: 'proposals',
