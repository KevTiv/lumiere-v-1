...
test.describe("Accounting module e2e", () => {
  ...
  test("creates fiscal year then accounting period", async ({ page }) => {
    ...
    await fillField(page, "dateFrom", isoDateTimeLocal(2099, 1, 1, 0, 0))
    await fillField(page, "dateTo", isoDateTimeLocal(2099, 12, 31, 23, 59))
    ...
    await fillField(page, "dateFrom", isoDateTimeLocal(2099, 1, 1, 0, 0))
    await fillField(page, "dateTo", isoDateTimeLocal(2099, 3, 31, 23, 59))
