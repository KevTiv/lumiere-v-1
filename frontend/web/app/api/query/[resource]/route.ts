...
import {
  ...
  serverQueryAccountMoveLines,
  serverQueryFixedAssets,
  serverQueryDepreciationLines,
  serverQueryTaxGroups,
  serverQueryTaxJurisdictions,
  serverQueryTaxSchedules,
  serverQueryTaxDeadlines,
  serverQueryIntercompanyRules,
  serverQueryIntercompanyTransactions,
...
const QUERY_MAP: Record<string, QueryFn> = {
  ...
  'account-move-lines': (orgId, opts) => serverQueryAccountMoveLines(orgId, opts),
  'account-moves': (orgId, opts) => serverQueryAccountMoves(orgId, undefined, opts),
  ...
  'fixed-assets': (orgId, opts) => serverQueryFixedAssets(orgId, opts),
  'depreciation-lines': (orgId, opts) => serverQueryDepreciationLines(orgId, opts),
  'tax-groups': (orgId, opts) => serverQueryTaxGroups(orgId, opts),
  'tax-jurisdictions': (orgId, opts) => serverQueryTaxJurisdictions(orgId, opts),
  'tax-schedules': (orgId, opts) => serverQueryTaxSchedules(orgId, opts),
  'tax-deadlines': (orgId, opts) => serverQueryTaxDeadlines(orgId, opts),
  'intercompany-rules': (orgId, opts) => serverQueryIntercompanyRules(orgId, opts),
  'intercompany-transactions': (orgId, opts) =>
    serverQueryIntercompanyTransactions(orgId, opts),
