...
export function useImportCountryCsv(organizationId: number) {
  return useMutation({
    mutationFn: async (csvData: string) => {
      const res = await fetch("/api/call/import_country_csv", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify([String(organizationId), csvData]),
      })
...
export function useImportCurrencyCsv(organizationId: number) {
  return useMutation({
    mutationFn: async (csvData: string) => {
      const res = await fetch("/api/call/import_currency_csv", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify([String(organizationId), csvData]),
      })
...
export function useImportCurrencyRateCsv(organizationId: number) {
  return useMutation({
    mutationFn: async (csvData: string) => {
      const res = await fetch("/api/call/import_currency_rate_csv", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify([String(organizationId), csvData]),
      })
...
export function useImportCompanyCsv(organizationId: number) {
  return useMutation({
    mutationFn: async (csvData: string) => {
      const res = await fetch("/api/call/import_company_csv", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify([String(organizationId), csvData]),
      })
...
export function useImportRoleCsv(organizationId: number) {
  return useMutation({
    mutationFn: async (csvData: string) => {
      const res = await fetch("/api/call/import_role_csv", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify([String(organizationId), csvData]),
      })
...
export function useImportAiAgentCsv(organizationId: number) {
  return useMutation({
    mutationFn: async (csvData: string) => {
      const res = await fetch("/api/call/import_ai_agent_csv", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify([String(organizationId), csvData]),
      })
