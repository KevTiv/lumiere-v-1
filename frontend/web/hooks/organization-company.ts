...
export function useCompanies(organizationId: number, enabled: boolean) {
  return useQuery({
    ...
    queryFn: async () => {
      const r = await fetch("/api/query/companies")
...
export function useDataClassifications(organizationId: number, enabled: boolean) {
  return useQuery({
    ...
    queryFn: async () => {
      const r = await fetch("/api/query/data-classifications")
      if (!r.ok) throw new Error(await parseCallError(r))
      const j = (await r.json()) as { data?: Record<string, unknown>[] }
      return j.data ?? []
    },
...
export function useDataClassificationRules(organizationId: number, enabled: boolean) {
  return useQuery({
    ...
    queryFn: async () => {
      const r = await fetch("/api/query/data-classification-rules")
      if (!r.ok) throw new Error(await parseCallError(r))
      const j = (await r.json()) as { data?: Record<string, unknown>[] }
      return j.data ?? []
    },
...
export function useCreateCompany(organizationId: number) {
  ...
  return useMutation({
    mutationFn: async (params: Record<string, unknown>) => {
      const r = await fetch("/api/call/create_company", {
        method: "POST",
...
export function useUpdateCompany() {
  ...
  return useMutation({
    mutationFn: async (args: { companyId: bigint; organizationId: number; params: Record<string, unknown> }) => {
      const r = await fetch("/api/call/update_company", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
export function useUpdateCompanyAddress() {
  ...
  return useMutation({
    mutationFn: async (args: { companyId: bigint; organizationId: number; params: Record<string, unknown> }) => {
      const r = await fetch("/api/call/update_company_address", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify([String(args.companyId), stdbParamsToJson(args.params as object)]),
      })
...
export function useUpdateCompanyBusiness() {
  ...
  return useMutation({
    mutationFn: async (args: { companyId: bigint; organizationId: number; params: Record<string, unknown> }) => {
      const r = await fetch("/api/call/update_company_business", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify([String(args.companyId), stdbParamsToJson(args.params as object)]),
      })
...
export function useUpdateCompanyHierarchy() {
  ...
  return useMutation({
    mutationFn: async (args: { companyId: bigint; organizationId: number; params: Record<string, unknown> }) => {
      const r = await fetch("/api/call/update_company_hierarchy", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify([String(args.companyId), stdbParamsToJson(args.params as object)]),
      })
...
export function useDeleteCompany() {
  ...
  return useMutation({
    mutationFn: async (args: { companyId: bigint; organizationId: number }) => {
      const r = await fetch("/api/call/delete_company", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
...
export function useCreateDataClassification(organizationId: number) {
  ...
  return useMutation({
    mutationFn: async (params: Record<string, unknown>) => {
      const r = await fetch("/api/call/create_data_classification", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify([String(organizationId), stdbParamsToJson(params as object)]),
      })
...
export function useCreateDataClassificationRule(organizationId: number) {
  ...
  return useMutation({
    mutationFn: async (params: Record<string, unknown>) => {
      const r = await fetch("/api/call/create_data_classification_rule", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify([String(organizationId), stdbParamsToJson(params as object)]),
      })
