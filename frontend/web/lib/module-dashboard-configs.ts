...
import {
  ...
  onboardingTemplatesTableConfig,
  newLeaveTypeForm,
  ...
  documentsRecycleBinTableConfig,
  documentTemplatesTableConfig,
  mailTemplatesTableConfig,
  newDocumentForm,
      ...
      widgets: [
        {
          ...
          data: {
            stats: [
              ...
              { label: "Revenue", value: "—", icon: "BarChart2" },
              { label: "Invoices Issued", value: "—", icon: "FileText" },
              { label: "Payments Received", value: "—", icon: "dollar" },
            ],
          },
        },
      ],
      ...
      widgets: [
        ...
        },
        {
          ...
          data: {
            categoryKey: "bucket",
            series: [
              { name: "AR", color: "#6366f1" },
              { name: "AP", color: "#ef4444" },
            ],
            values: [],
            stacked: false,
          },
    ...
    },
    {
      ...
      widgets: [
        ...
        },
        {
          ...
          type: "bar-chart",
          title: "Top Products by Stock Movement",
          width: "1/2",
          data: {
            categoryKey: "product",
            series: [{ name: "Moves", color: "#6366f1" }],
            values: [],
          },
        },
      ],
  ...
  sections: [
    ...
    },
    {
      ...
      widgets: [
        ...
        {
          id: "hr-headcount-trend",
          type: "line-chart",
          title: "Headcount Trend",
          width: "1/2",
          data: {
            xAxisKey: "month",
            series: [{ name: "Headcount", color: "#6366f1" }],
            values: [],
          },
        },
      ],
...
export const hrModuleConfig = (t: TFunction): ModuleConfig => ({
  ...
  tabs: [
    ...
    },
    {
      ...
      label: "Attendance",
      type: "entity",
      entityConfig: attendanceTableConfig(t),
      createForm: newAttendancePunchForm(t),
      createLabel: "Record Punch",
      createAction: "createAttendancePunch",
    },
    {
      id: "contracts",
      label: "Contracts",
    ...
    },
    {
      ...
      label: "Onboarding",
      type: "entity",
      entityConfig: onboardingTemplatesTableConfig(t),
      ...
      widgets: [
        {
          ...
          data: {
            ...
            actions: [
              ...
              { id: "log_timesheet", label: "Log Time", icon: "refresh", color: "orange" },
              { id: "start_timer", label: "Start Timer", icon: "trending", color: "teal" },
            ],
          },
        },
      ],
      ...
      widgets: [
        {
          ...
          data: {
            stats: [
              ...
              { label: "To validate", value: "—", icon: "CheckSquare" },
              { label: "Unbilled hours", value: "—", icon: "AlertCircle" },
...
export const projectsModuleConfig = (t: TFunction): ModuleConfig => ({
  ...
  tabs: [
    ...
    },
    {
      ...
      label: "Rate cards",
      type: "entity",
      entityConfig: rateCardsTableConfig(t),
      createForm: newProjectRateCardForm(t),
      createLabel: "New rate card",
      createAction: "createRateCard",
    },
    {
      id: "resources",
      label: "Resources",
...
export const documentsModuleConfig = (t: TFunction): ModuleConfig => ({
  ...
  tabs: [
    ...
    {
      id: "documents-recycle-bin",
      label: "Recycle bin",
      type: "entity",
      entityConfig: documentsRecycleBinTableConfig(t),
    },
    {
      id: "document-templates",
      label: "Doc templates",
      type: "entity",
      entityConfig: documentTemplatesTableConfig(t),
      createForm: newDocumentTemplateForm(t),
      createLabel: "New document template",
      createAction: "createDocumentTemplate",
    },
    {
      id: "mail-templates",
      label: "Mail templates",
      type: "entity",
      entityConfig: mailTemplatesTableConfig(t),
      createForm: newMailTemplateForm(t),
      createLabel: "New mail template",
      createAction: "createMailTemplate",
    },
    {
...
export const subscriptionsModuleConfig = (t: TFunction): ModuleConfig => ({
  ...
  tabs: [
    ...
    {
      id: "lines",
      label: t("subscriptions.lines.tabLabel", { defaultValue: "Lines" }),
      type: "entity",
      entityConfig: subscriptionLinesTableConfig(t),
    },
    {
      id: "amendments",
      label: t("subscriptions.amendments.tabLabel", { defaultValue: "Amendments" }),
      type: "entity",
      entityConfig: subscriptionAmendmentsTableConfig(t),
    },
    {
      id: "usage-events",
      label: t("subscriptions.usageEvents.tabLabel", { defaultValue: "Usage events" }),
      type: "entity",
      entityConfig: subscriptionUsageEventsTableConfig(t),
    },
    {
      id: "usage-charges",
      label: t("subscriptions.usageCharges.tabLabel", { defaultValue: "Usage charges" }),
      type: "entity",
      entityConfig: subscriptionUsageChargesTableConfig(t),
    },
    {
      id: "rating-backlog",
      label: t("subscriptions.ratingBacklog.tabLabel", { defaultValue: "Rating backlog" }),
      type: "entity",
      entityConfig: subscriptionRatingBacklogTableConfig(t),
    },
    {
      id: "price-tiers",
      label: t("subscriptions.priceTiers.tabLabel", { defaultValue: "Price tiers" }),
      type: "entity",
      entityConfig: subscriptionPriceTiersTableConfig(t),
      createForm: createSubscriptionPriceTierForm(t),
      createLabel: "Add tier",
      createAction: "createPriceTier",
    },
    {
      id: "past-due",
      label: t("subscriptions.pastDue.tabLabel", { defaultValue: "Past due" }),
      type: "entity",
      entityConfig: subscriptionPastDueTableConfig(t),
    },
    {
      id: "due-to-bill",
    ...
    {
      id: "entitlements",
      label: t("subscriptions.entitlements.tabLabel", { defaultValue: "Entitlements" }),
      type: "entity",
      entityConfig: subscriptionEntitlementsTableConfig(t),
    },
    {
      id: "payment-intents",
      label: t("subscriptions.paymentIntents.tabLabel", { defaultValue: "Payment intents" }),
      type: "entity",
      entityConfig: subscriptionPaymentIntentsTableConfig(t),
    },
    {
...
export const workflowsModuleConfig = (t: TFunction): ModuleConfig => ({
  ...
  tabs: [
    ...
    },
    {
      ...
      createForm: newWorkflowMigrationPlanForm(t),
