...
export const ALL_REDUCER_NAMES = [
  ...
  'delete_ai_capability_role_grant',
  ...
  'register_ai_intelligence_policy',
  'register_ai_model_profile',
  ...
  'run_c0_organization_ownership_backfill',
  'run_cartonization',
  ...
  'set_ai_calibration_profile_active',
  'set_ai_capability_role_grant',
  'set_ai_decision_case_outcome',
  'set_ai_decision_case_status',
  'set_ai_decision_case_verification',
  'set_ai_decision_pattern_status',
  'set_ai_decision_type_active',
  'set_ai_evidence_passage_status',
  'set_ai_intelligence_event_acceptance',
  'set_ai_intelligence_event_escalation',
  'set_ai_intelligence_event_verification',
  'set_ai_intelligence_policy_active',
  'set_ai_knowledge_entry_version_state',
  'set_ai_model_profile_active',
  ...
  'validate_budget',
  'validate_c0_organization_ownership_backfill',
