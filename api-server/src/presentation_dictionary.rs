...
const CONTRACT_PIN: &str = "v0.3.49";
...
mod tests {
    ...
    fn returns_pinned_provenance_and_registry_projection() {
        ...
        assert_eq!(capability.contract_pin, "v0.3.49");
    ...
    fn contract_pin_matches_api_dependency_pin() {
        ...
        assert!(workspace.contains("lumiere-contracts = { git = \"ssh://git@github.com/KevTiv/lumiere-contracts.git\", tag = \"v0.3.49\""));
    }
}
