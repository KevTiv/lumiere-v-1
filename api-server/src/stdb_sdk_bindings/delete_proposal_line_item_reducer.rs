...
impl __sdk::InModule for DeleteProposalLineItemArgs {
    type Module = super::RemoteModule;
}

#[allow(non_camel_case_types)]
/// Extension trait for access to the reducer `delete_proposal_line_item`.
///
/// Implemented for [`super::RemoteReducers`].
pub trait delete_proposal_line_item {
