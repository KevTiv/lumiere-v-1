...
impl From<ConfirmManufacturingOrderArgs> for super::Reducer {
...
impl __sdk::InModule for ConfirmManufacturingOrderArgs {
    type Module = super::RemoteModule;
}

#[allow(non_camel_case_types)]
/// Extension trait for access to the reducer `confirm_manufacturing_order`.
///
/// Implemented for [`super::RemoteReducers`].
pub trait confirm_manufacturing_order {
...
impl confirm_manufacturing_order for super::RemoteReducers {
    fn confirm_manufacturing_order_then(
        &self,
        organization_id: u64,
        company_id: u64,
