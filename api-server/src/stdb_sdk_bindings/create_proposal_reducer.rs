...
impl __sdk::InModule for CreateProposalArgs {
    type Module = super::RemoteModule;
}

#[allow(non_camel_case_types)]
/// Extension trait for access to the reducer `create_proposal`.
///
/// Implemented for [`super::RemoteReducers`].
pub trait create_proposal {
    ...
    /// /// Use [`create_proposal:create_proposal_then`] to run a callback after the reducer completes.
    fn create_proposal(
        &self,
        organization_id: u64,
        company_id: u64,
...
impl create_proposal for super::RemoteReducers {
    fn create_proposal_then(
        &self,
        organization_id: u64,
        company_id: u64,
