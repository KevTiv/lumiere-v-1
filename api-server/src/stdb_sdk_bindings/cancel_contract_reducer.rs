...
impl From<CancelContractArgs> for super::Reducer {
...
impl __sdk::InModule for CancelContractArgs {
    type Module = super::RemoteModule;
}

#[allow(non_camel_case_types)]
/// Extension trait for access to the reducer `cancel_contract`.
///
/// Implemented for [`super::RemoteReducers`].
pub trait cancel_contract {
...
impl cancel_contract for super::RemoteReducers {
    fn cancel_contract_then(
        &self,
        organization_id: u64,
        company_id: u64,
