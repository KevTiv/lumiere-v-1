...
| 7 | [H5 budget/model routing](./ai-harness-h5-persistence-handoff.md#h5b-durable-budget-contract) | new child / policy slice | Luna routing agent; coordinator owns STDB integration | Atomic reservation/charge, allowed-model routing, bounded Mistral-to-Gemini fallback | Durable reservation contract and immutable release required before gateway wiring |
