...
use crate::core::operational_messaging::{
    ...
    CreateOperationalMessageParams, MessageChannel, MessageTemplateVariable,
    OperationalMessageStatus,
};
use crate::crm::contacts::{contact, create_contact, CreateContactParams};
use crate::crm::contact_identities::ContactPhoneIdentity;
use crate::test_harness::{ensure_test_superuser, OrgFixture};
use crate::types::{ContactIdentityKind, ContactVerificationState, PartnerType};
...
fn seed_contact_with_phone(
    ...
    ctx.db.contact_phone_identity().insert(ContactPhoneIdentity {
        ...
        normalized_e_164: "+15550101001".to_string(),
